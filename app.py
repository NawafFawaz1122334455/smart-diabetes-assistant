بالتأكيد! إليك الكود الكامل والمُجَمَّع الذي يحتوي على جميع التعديلات المطلوبة (استخدام رمز OTP لـ "نسيت كلمة المرور")، بالإضافة إلى دوال المصادقة، وإدارة المنتجات، وصفحات العرض.

يمكنك نسخ هذا الكود ولصقه مباشرة في ملفك.
