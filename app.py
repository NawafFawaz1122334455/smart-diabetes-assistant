...
def show_home_page():
    ...
    # 🌟🌟🌟 التصحيح النهائي: استخدام المسار النسبي 🌟🌟🌟
    # هذا المسار يقول: "ابحث في مجلد 'images' عن ملف 'smart.jpg'"
    image_name = "images/smart.jpg"
    
    try:
        # عرض الصورة من المسار النسبي الصحيح
        st.image(image_name, width=400) 
        
    except Exception:
        # رسالة تحذير مفيدة
        st.warning(f"تحذير: لم يتم العثور على الملف '{image_name}'. تأكد من وجود مجلد 'images' ووضع الصورة بداخله.")
