...
def show_home_page():
    ...
    # 🌟🌟🌟 الكود الجديد للصورة مع اسم التطبيق 🌟🌟🌟
    # استخدام رابط صورة عامة ذات خلفية مناسبة أو مرتبطة بالصحة
    image_url = "https://images.unsplash.com/photo-1506126616403-bb6d4c5f95e5?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    
    try:
        # عرض الصورة باستخدام الرابط
        st.image(image_url, width=400) 
        
        # إضافة اسم التطبيق كنص فوق الصورة (أو أسفلها بقليل)
        # يمكنك تعديل اللون، الحجم، والموقع (باستخدام st.markdown أو st.write)
        st.markdown(f"<h2 style='text-align: center; color: #008080;'>SMART DA</h2>", unsafe_allow_html=True)
        st.markdown(f"<p style='text-align: center; color: gray;'>مساعد السكري الذكي</p>", unsafe_allow_html=True)

    except Exception as e:
        st.warning(f"فشل تحميل الصورة من الرابط. يرجى التحقق من اتصالك بالإنترنت.")
    # 🌟🌟🌟 نهاية الكود الجديد 🌟🌟🌟
